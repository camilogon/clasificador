...
imagenes,etiquetas,probabilidades=cargarDatos("../Images/dataset/",num_clases,limiteImagenesPrueba)
...
imagenesPrueba,etiquetasPrueba,probabilidadesPrueba=cargarDatos("../Images/test/",num_clases,limiteImagenesPrueba)
